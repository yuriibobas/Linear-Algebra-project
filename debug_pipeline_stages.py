...
def main():
    ...
    win_stride = (
        _get(cfg, "detection", "win_stride_w", 8),
        _get(cfg, "detection", "win_stride_h", 8),
    )
    padding = (
        _get(cfg, "detection", "padding_w", 8),
        _get(cfg, "detection", "padding_h", 8),
    )
    ...
    # Stage 1: preprocessed image for HOG
    ...
    # Stage 4: translation target and moved persons
    ...
    # Stage 5: background-first inpainting
    ...
    # Stage 6: compositing translated persons
